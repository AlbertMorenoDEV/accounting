...
class ModifyAccountHistoryConceptTest extends PHPUnit_Framework_TestCase
{
	private $repo;
	...
	{
		$usecase = new ModifyAccountHistoryConcept($this->repo, new AccountHistoryUuid);
		$usecase->execute($this->id, "Ebay");
		$this->assertEquals("Ebay", $this->accountHistory->getConcept());
	}
}