...
class ModifyAccountHistoryDateTest extends PHPUnit_Framework_TestCase
{
	private $repo;
	...
	{
		$usecase = new ModifyAccountHistoryDate($this->repo, new AccountHistoryUuid);
		$usecase->execute($this->id, new \DateTime("2014-10-29 16:17:01"));
		$this->assertEquals(new \DateTime("2014-10-29 16:17:01"), $this->accountHistory->getDate());
	}
}